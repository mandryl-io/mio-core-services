...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=int,
        default=2400,
        help="How fast each servo tracks its jogging goal.",
    )
    ...
    with STS3215Bus(args.port) as bus:
        ...
        bus.prepare(servo_id=args.id_1, speed=args.speed, acc=50)
        bus.prepare(servo_id=args.id_2, speed=args.speed, acc=50)
