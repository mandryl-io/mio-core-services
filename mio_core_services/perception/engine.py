...
from mio_core_services.perception.occupancy import PRESENCE_PREFIX, Occupancy
...
class PerceptionEngine(FrameProcessor):
    ...
    Place immediately after ``transport.input()``. Image frames are swallowed
    so pixels never reach the LLM. No LLMRunFrame — Mio may mention who is
    facing the camera on a turn it was already going to take.
    """
